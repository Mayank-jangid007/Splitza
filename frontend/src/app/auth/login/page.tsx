...
export const metadata: Metadata = {
  title: "Sign In — Splitza",
  description: "Sign in to your Splitza account to manage your subscriptions, slots, and payouts.",
};
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-container">
        ...
        <div className="auth-left hide-mobile">
          <Link href="/" className="auth-logo" aria-label="Splitza home">
            ...
            <span className="navbar-logo-text" style={{ color: "white" }}>Splitza</span>
          </Link>

          <div className="auth-left-content">
            <h1 className="text-h2" style={{ color: "white" }}>Welcome back to Splitza.</h1>
            <p className="text-body-lg" style={{ color: "rgba(255,255,255,0.75)" }}>
              Your slots, payouts, and trust scores are waiting. Sign in to continue saving.
            </p>

            <div className="auth-left-stats">
              {[
                { icon: "💳", value: "Zero fees", label: "No platform cut on first month" },
                { icon: "⚡", value: "Instant", label: "Payouts via UPI in seconds" },
                { icon: "🔒", value: "Secure", label: "Escrow-protected every transaction" },
              ].map((s) => (
          ...
          <p className="auth-left-footer text-body-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
        ...
        <div className="auth-right">
          <div className="auth-form-wrapper">
            <div className="hide-desktop" style={{ display: "none", marginBottom: "var(--space-6)" }}>
            ...
            <h2 className="text-h3 auth-form-title">Sign in to your account</h2>
      ...
      <style>{`
        ...
        .auth-logo { display: flex; align-items: center; gap: var(--space-3); text-decoration: none; z-index: 1; }
        .auth-left-content { display: flex; flex-direction: column; gap: var(--space-6); z-index: 1; }
        ...
        .auth-stat-value { font-family: var(--font-heading); font-size: 1.125rem; font-weight: 800; color: white; }
